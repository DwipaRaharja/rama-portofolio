...
export function AboutSection() {
  return (
    <section
      id="about"
      className="relative flex min-h-[calc(100vh-6rem)] scroll-mt-24 flex-col justify-center pb-20 pt-8 text-white sm:pb-24 sm:pt-10 lg:min-h-[calc(100vh-6rem)] lg:pb-28 lg:pt-12"
    >
      <AboutFlowLines className="pointer-events-none absolute inset-x-0 -top-2 h-[390px] w-full text-white/10 sm:h-[440px]" />
      <DotGrid className="absolute -left-4 bottom-24 hidden text-white/15 md:grid" />
      ...
      <Container className="relative z-10">
        <div className="grid items-center gap-12 lg:grid-cols-[320px_1fr]">
          ...
          <Reveal direction="up" delay={0.08}>
            ...
            <p className="mt-5 max-w-[760px] text-sm leading-7 text-zinc-400 sm:text-base">
        ...
        >
          <p className="text-sm font-semibold italic text-zinc-300 sm:text-base">
